...
const Home = () => {
  ...
  return (
    <div className='mainofmain'>
      ...
      <div className='hardwareimg' style={{ paddingBottom: '270px', position: 'absolute' }}>
        <Card style={{ width: '28rem', height: '42vh', position: 'absolute', margin: '130px 0 0 190px' }}>
          <Card.Body>
            <Card.Title><h2>Original and Quality</h2></Card.Title>
            <Card.Subtitle className="mb-2 text-muted"><h1 style={{ fontFamily: 'revert', color: 'black' }}><b>Hardware Products</b></h1></Card.Subtitle>
            <Card.Text>
              Household Hardware for Home improvement including: Fasteners, power tools,
              locks, hinges, chains, plumbing, electrical, housewares,
              paint and garden products directly to consumers for use at home or for business.
            </Card.Text>
            <Link to="/hardware">
        ...
        <div>
          <img src={Hardwareimg} style={{ height: '35pc', paddingLeft: '522px', marginBottom:'16pc' }} />
        </div>
      </div>
        ...
        <div className='card2'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            ...
            <Card.Body>
              ...
              <div style={{display:'flex'}}>
              <h5 style={{ textDecoration: 'line-through', color:'gold' }}>₹1,530.00</h5>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            ...
            <Card.Body>
              ...
              <div style={{display:'flex'}}>
              <h5 style={{ textDecoration: 'line-through', color:'gold' }}>₹5,030.00</h5>
    ...
    <div className="slider-container" style={{margin:'0 150px 0 190px'}}>
      <Slider {...settings}>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={hydraulichinges} style={{height:'30vh'}}/>
            <Card.Body>
              ...
              <div style={{display:'flex'}}>
              <h5 style={{ textDecoration: 'line-through', color:'gold' }}>₹539.00</h5>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={tilehammer} style={{height:'30vh'}}/>
            <Card.Body>
              <Card.Title>Tile Soft Hammer</Card.Title>
              <Card.Text>
              Rubber Round Head and Non-Slip Comfortable Grip Handle Soft Face Hammer for Tiles.
              </Card.Text>
              <div style={{display:'flex'}}>
              <h5 style={{ textDecoration: 'line-through', color:'gold' }}>₹699.00</h5>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={steelnutbolt} style={{height:'30vh'}}/>
            <Card.Body>
              <Card.Title>Steel Nut Bolt</Card.Title>
              <Card.Text>
              Stainless Steel bolt With Nut & Flat Washer. All size Nut Bolt Available. It does'nt Rust.
              </Card.Text>
              <div style={{display:'flex'}}>
              <h5 style={{ textDecoration: 'line-through', color:'gold' }}>₹299.00</h5>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={allenkeyset} style={{height:'30vh'}}/>
            <Card.Body>
              <Card.Title>Allen Key Set</Card.Title>
              <Card.Text>
              Allen Key Set, Rust resistant coating. Allen key set for bike, car, cycle, heavy vehicles and machinery.
              </Card.Text>
              <div style={{display:'flex'}}>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={screwdriverset} style={{height:'30vh'}}/>
            <Card.Body>
              <Card.Title>Screw Driver Set</Card.Title>
              <Card.Text>
              Precision screw driver set for computer, mobile repairing tool kit, laptop repairing and multipurpose.
              </Card.Text>
              <div style={{display:'flex'}}>
    ...
    <div className='card4' style={{display:'flex', marginLeft:'190px',gap:'30px'}}>
    <div className='card1'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={smartlocks} style={{height:'30vh'}} />
            <Card.Body>
              <Card.Title>Door Smart Lock</Card.Title>
              <Card.Text >
              Smart Door Lock | 5 Ways Unlocking | Fingerprint | PIN | OTP | NFC Card | Key | 5 Stainless Steel Bolt. 
              </Card.Text>
              <div style={{display:'flex'}}>
        ...
        <div className='card1'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={kitchenhydraulic} style={{height:'30vh'}} />
            <Card.Body>
              <Card.Title>Hydraulic Shocker</Card.Title>
              <Card.Text >
              Kitchen Cabinet Gas Piston Spring Kitchen Cabinet Stay Shocker Strut Hydraulic Lift Support.
              </Card.Text>
              <div style={{display:'flex'}}>
              <h5 style={{ textDecoration: 'line-through', color:'gold' }}>₹499.00</h5>
              <h5 style={{ textDecoration: 'underline' }}>₹349.00</h5>
        ...
        <div className='card5' style={{display:'flex', marginLeft:'190px',gap:'30px'}}>
        <div className='card1'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={doorseal} style={{height:'30vh'}} />
            <Card.Body>
              <Card.Title>Door Seal</Card.Title>
              <Card.Text >
              Window Home Door Seal (94cm/36.5") Aluminium Plate with Nylon Brush (Chocolate, 2).
              </Card.Text>
              <div style={{display:'flex'}}>
              <h5 style={{ textDecoration: 'line-through', color:'gold' }}>₹589.00</h5>
        ...
        <div className='card1'>
          <Card style={{ width: '15rem',margin:'30px 0 80px 0'}}>
            <Card.Img variant="top" src={fingerpullhandel} style={{height:'30vh'}} />
            <Card.Body>
              <Card.Title>Fingerpull Handel</Card.Title>
              <Card.Text >
              Style Finger Edge Pull Furniture DrawerHandles Hidden Cabinet Kitchen Drawer Handles Ivory,Black. 
              </Card.Text>
              <div style={{display:'flex'}}>
              <h5 style={{ textDecoration: 'line-through', color:'gold' }}>₹513.00</h5>
    ...
    <Card style={{ width: '25rem',height:'65vh' , opacity:'0.9',margin:'230px 0 0 80px'}}>
      <Card.Body>
        <Card.Title><h2><b>New Products Enhance and Glowing the Beauty of Home.</b></h2></Card.Title>
        <Card.Subtitle className="mb-2 text-muted" style={{fontSize:'20px',marginTop:'10px',fontFamily:'sans-serif'}}>  Many hardware stores have specialty departments unique to its region or its owner's 
          interests. Chain, Smart Locks, Heavy Channel, etc.</Card.Subtitle>
        <Card.Text style={{marginTop:'20px'}}>
        <MdOutlineDone style={{color:'gold',fontSize:'20px'}}/>Handel Sets         <MdOutlineDone style={{color:'gold',fontSize:'20px',marginLeft:'36px'}}/>Threaded fasteners<br/> 
        <MdOutlineDone style={{color:'gold',fontSize:'20px'}}/>Dead Bolts    <MdOutlineDone style={{color:'gold',fontSize:'20px',marginLeft:'44px'}}/>Wardrobe Sliding<br/>
        <MdOutlineDone style={{color:'gold',fontSize:'20px'}}/>Mortise Locks     <MdOutlineDone style={{color:'gold',fontSize:'20px',marginLeft:'23px'}}/>Fingerpull Handel<br/>
        <MdOutlineDone style={{color:'gold',fontSize:'20px'}}/>Hand Tool Kit    <MdOutlineDone style={{color:'gold',fontSize:'20px',marginLeft:'26px'}}/>Door Seal<br/>
        <MdOutlineDone style={{color:'gold',fontSize:'20px'}}/>Bearing Hinges     <MdOutlineDone style={{color:'gold',fontSize:'20px',marginLeft:'14px'}}/>Hydraulic Shocker
        </Card.Text>
        <Link to="/hardware">
    ...
    <div className="main5">
    <div className='electric' style={{backgroundColor:'rgb(31, 42, 42)'}}>
      <h1 style={{color:'white', padding:'20px', fontFamily:'-moz-initial'}}>Electrical Items</h1>
      <img src={electricimg} style={{margin:'0px 0 260px 0', height:'35pc', width:'62pc'}}></img>
    </div>
    <div className="electriccard" style={{backgroundColor:'rgb(31, 42, 42)', margin:'-680px 0px 0px 854px', position:'absolute'}}>
    <Card style={{ width: '28rem', height: '42vh', position: 'absolute' }}>
          <Card.Body>
            <Card.Title><h2>Original and Quality</h2></Card.Title>
            <Card.Subtitle className="mb-2 text-muted"><h1 style={{ fontFamily: 'revert', color: 'black' }}><b>Electrical Products</b></h1></Card.Subtitle>
            <Card.Text>
            Some of the usually named classes of electrical appliances at home are Household Appliances,
             Kitchen Appliances, Compact Appliances, Small Appliances, Floor-care Appliances, Personal-care Appliances,
            </Card.Text>
            <Link to="/electric">
    ...
    <div className='electricproducts'>
        ...
        <div className='card1'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={modulerswitch} style={{height:'30vh'}} />
            <Card.Body>
              <Card.Title>Moduler Switch</Card.Title>
              <Card.Text >
              <b>Pack of 10 Pieces 6AMP Modular Switch.</b><br/> 1 Way 6 Amp. Switch, Color (White, Black, Silver)
              </Card.Text>
              <div style={{display:'flex'}}>
              <h5 style={{ textDecoration: 'line-through', color:'gold' }}>₹499.00</h5>
        ...
        <div className='card1'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={fourpollmcb} style={{height:'30vh'}} />
            <Card.Body>
    ...
    <div className="slider-container" style={{margin:'0 150px 0 190px'}}>
      <Slider {...settings}>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={modulersoket} style={{height:'30vh'}}/>
            <Card.Body>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={conduitpipebundle} style={{height:'30vh'}}/>
            <Card.Body>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={multiplug} style={{height:'30vh'}}/>
            <Card.Body>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={tubelight} style={{height:'30vh'}}/>
            <Card.Body>
        ...
        <div className='card3'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={ledbulb} style={{height:'30vh'}}/>
            <Card.Body>
    ...
    <div className='card1'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={wateralarm} style={{height:'30vh'}} />
            <Card.Body>
        ...
        <div className='card1'>
          <Card style={{ width: '15rem',marginTop:'30px'}}>
            <Card.Img variant="top" src={studylamp} style={{height:'30vh'}} />
            <Card.Body>
        ...
        <div className='card1'>
          <Card style={{ width: '15rem',margin:'30px 0 80px 0'}}>
            <Card.Img variant="top" src={callbell} style={{height:'30vh'}} />
            <Card.Body>
    ...
    <Card style={{ width: '25rem',height:'65vh' , opacity:'0.9',margin:'230px 0 0 80px'}}>
      <Card.Body>
        <Card.Title><h2><b>New Products Enhance and Glowing the Beauty of Home.</b></h2></Card.Title>
        <Card.Subtitle className="mb-2 text-muted" style={{fontSize:'20px',marginTop:'10px',fontFamily:'sans-serif'}}>  Many electrical stores have specialty departments unique to its region or its owner's 
          interests. Chain, Smart Locks, Heavy Channel, etc.</Card.Subtitle>
        <Card.Text style={{marginTop:'20px'}}>
        <MdOutlineDone style={{color:'gold',fontSize:'20px'}}/>Conduit Pipes<MdOutlineDone style={{color:'gold',fontSize:'20px',marginLeft:'40px'}}/>Water Alarm<br/> 
        <MdOutlineDone style={{color:'gold',fontSize:'20px'}}/>Conduit Fittings<MdOutlineDone style={{color:'gold',fontSize:'20px',marginLeft:'26px'}}/>Distribution Switchgears<br/>
        <MdOutlineDone style={{color:'gold',fontSize:'20px'}}/>Electrical Switches    <MdOutlineDone style={{color:'gold',fontSize:'20px',marginLeft:'8px'}}/>Doorbells<br/>
    ...
    <div className="main9">
    <div className='sanitary' style={{backgroundColor:'rgb(31, 42, 42)'}}>
      <h1 style={{color:'white', padding:'20px', fontFamily:'-moz-initial'}}>Sanitary Items</h1>
      <img src={sanitaryware} style={{margin:'0px 0 16pc 527px', height:'35pc', width:'62pc'}}></img>
    </div>
    <div className="electriccard" style={{backgroundColor:'rgb(31, 42, 42)', margin:'-695px 0px 0px 188px', position:'absolute'}}>
    <Card style={{ width: '28rem', height: '42vh', position: 'absolute' }}>
          <Card.Body>
            <Card.Title><h2>Original and Quality</h2></Card.Title>
            <Card.Subtitle className="mb-2 text-muted"><h1 style={{ fontFamily: 'revert', color: 'black' }}><b>Sanitary Products</b></h1></Card.Subtitle>
            <Card.Text>
            The plumbing system includes pipes made of materials like copper, PVC, and brass, 
