        ...
        <div className='footer'>
            ...
            <div className='footer-content'>
                ...
                <div className='footer-section contact-info'>
                    ...
                    <p>Install Good Quality Materials in your House or Strengthen the House.</p>
                    <p><FaMapLocationDot />  87, Jai Karani Nagar, Niwaru Road, Jaipur</p>
                    <p><IoIosCall />  +91 9785098898, 9694490409</p>
                    <p><MdEmail />  ridhisidhi17@gmail.com</p>
                </div>
            ...
            <div className='footer-bottom'>
                © 2024 Copyright: <a href="/">RidhiSidhi.com</a>
            </div>
        </div>
    );
};
